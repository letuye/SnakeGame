...
import high_score
class GameOver:
	def __init__(self, interface, score=0, high_score=0):
	...
	def draw(self):
		...
		#######demo hien thi diem cao nhat
		high_score_file = r"D:\python\SnakeGame\data\high_score.txt"
		...
		self.play_again_button = draw_button(self.screen, "Play Again", self.width //2, self.height //2 , self.width //5, self.height //12, self.height //20, "#27E7C9","#22bda5")
		self.back_button = draw_button(self.screen, "Home", self.width //2, self.height //2 + self.height //6 , self.width //5, self.height //12, self.height //20, "#27E7C9","#22bda5")
		self.quit_button = draw_button(self.screen, "Quit", self.width //2, self.height //2 + self.height //3, self.width //5, self.height //12, self.height //20, "#27E7C9","#22bda5")
